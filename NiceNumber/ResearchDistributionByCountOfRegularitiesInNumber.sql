...
select T.RCount, T1.NCount as NCount8, T2.NCount as NCount9, T3.NCount as NCount10, T4.NCount as NCount11, T5.NCount as NCount12 from 
...
select STR(T.RCount + 1) + '-' + LTRIM(STR(T.RCount + 5)), T1.NCount as NCount8, T2.NCount as NCount9, T3.NCount as NCount10, T4.NCount as NCount11, T5.NCount as NCount12 from 
